...
export default function AdminNotifications() {
  ...
  return (
    <div className="min-h-screen bg-stone-50" data-testid="admin-notifications-page">
      {/* Header */}
      <header className="bg-white border-b border-stone-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link to="/admin" className="flex items-center gap-2 text-stone-600 hover:text-maroon-500">
          ...
          <CardContent className="p-0">
            {loading ? (
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-stone-500">You'll be notified about new requests and important updates</p>
              </div>
            ) : (
