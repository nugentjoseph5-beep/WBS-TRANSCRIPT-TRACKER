...
import { ArrowLeft, Bell, BellOff, CheckCheck, FileText, Upload, AlertCircle } from 'lucide-react';
          ...
          <CardContent className="p-0">
            {loading ? (
              ...
              <div className="p-8 text-center">
                ...
                <p className="text-stone-500">You'll be notified when there are updates to your requests</p>
              </div>
            ) : (
                        ...
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <div className="flex items-center gap-2">
                            {notification.request_id && (
                              <Link to={`/student/request/${notification.request_id}`}>
